...
export const Normal: Story = {
    args: {
        info: {
            ...
            workingField: "Construction",
            group: "SilverBack",
            email: "mail@silverback-group.eu",
            phone: "+49 1234567890",
            address: {
                street: "Mews Station",
                city: "Dublin 9",
