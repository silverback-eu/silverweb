...
export default function PrivacyPolicy(): JSX.Element {
  return (
    <div className="mx-auto max-w-4xl px-4  ">
      ...
      <ul className="list-disc space-y-2 py-2 pl-12">
        <li>
      ...
      <h2 className="mb-2 pt-20 text-xl font-bold tracking-tighter sm:text-2xl">
      ...
      <ol className="list-decimal space-y-2 py-2 pl-12">
        <li>
          <Button asChild className="h-auto p-0 text-base" variant="link">
      ...
      <h2
        className="mb-2 pt-20 text-xl font-bold tracking-tighter sm:text-2xl"
      ...
      <h3 className="mb-2 pt-4 text-lg font-bold tracking-tight">
      ...
      <h2
        className="m b-2 pt-20 text-xl font-bold tracking-tighter sm:text-2xl"
