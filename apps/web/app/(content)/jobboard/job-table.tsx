...
export const columnsJob: ColumnDef<Job>[] = [
  ...
  },
  {
    accessorKey: "company",
    cell: ({ row }) => (
      <div className="grid w-[calc(100%-40px)] content-center">
        <p className="truncate text-start text-sm font-semibold md:text-base">
        ...
        <div className="flex justify-between">
          <p className="truncate text-start text-xs text-warm md:text-sm">
  ...
  {
    accessorKey: "country",
    cell: () => <div className="absolute hidden" />,
    filterFn: (row, id, value) =>
      (value as string[]).includes(
        (row.getValue(id) as string).toLowerCase().replace(/ /g, "-"),
      ),
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex-1">
        <Button
          asChild
          className="px-0 pr-2 text-xs md:px-4 md:text-sm"
          variant="link"
        >
