...
const PasswordInput = forwardRef<HTMLInputElement, PasswordInputProps>(
  (props, ref) => {
    ...
    const [showPassword, setShowPassword] = useState((disabled || readOnly)? true : false);
    ...
    return (
      <div className="relative">
        <Input
          ...
          {...rest}
        />
        <div ref={IconContainerRef} className="transition-all absolute inset-y-0 right-3 flex items-center text-muted-foreground cursor-pointer" onClick={() => {setShowPassword(!showPassword)}}>
