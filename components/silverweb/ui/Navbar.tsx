              ...
              <NavAppIcon
                ...
                content={
                  <div className="grid gap-5">
                    ...
                    <Separator />
                    <HomeInsidesCards {...{icon: <Tags size={20}/>, link: '#', name: 'open tasks', number: 14}} />
                    <HomeInsidesCards {...{icon: <BellRing size={18}/>, link: '#', name: 'notifs.', number: 23}} />
                    <Separator />
                    ...
                    <HomeInsidesCards {...{icon: <Users2 size={18}/>, link: '/sw/', name: 'Employees', number: 523}} />
                  </div>
                }
              />
              <NavAppIcon
...
function HomeInsidesCards({link, name, icon, number}: { link: string, name: string, icon: React.JSX.Element, number: number }) {
  return (
    <Link href={link}>
