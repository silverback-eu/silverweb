    ...
    <div className="relative">
      <div className="text-center">
            ...
            <div className="grid lg:grid-cols-[0.4fr_1fr] gap-7 sm:gap-14 mt-[130px] min-[380px]:mt-[90px]  sm:mt-[230px] mx-5 sm:mx-14 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="hidden sm:flex justify-center lg:justify-start mx-2 gap-2 mt-3">
                  <PhoneInput popoverClassName="light" placeholder="353 1 441 0102" />
        ...
        <section aria-label="Show Partner">
          <div className="mt-64">
            <div className="font-bold text-5xl tracking-tighter">Trusted by our partners</div>
...
//         heroCardsAreVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20",
//       )}
//     >
...
//         <p className="text-black hidden md:block min-[1125px]:text-lg font-medium">{content}</p>
...
//                   0% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 124.93333333333334,234.13333333333335 249.86666666666667,268.2666666666667 397,274 C 544.1333333333333,279.7333333333333 713.4666666666667,257.0666666666666 891,240 C 1068.5333333333333,222.93333333333337 1254.2666666666667,211.4666666666667 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   25% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 165.06666666666666,156.13333333333333 330.1333333333333,112.26666666666668 475,126 C 619.8666666666667,139.73333333333332 744.5333333333333,211.06666666666666 902,233 C 1059.4666666666667,254.93333333333334 1249.7333333333333,227.46666666666667 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   50% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 167.19999999999993,216.93333333333334 334.39999999999986,233.86666666666667 514,246 C 693.6000000000001,258.1333333333333 885.6000000000001,265.4666666666667 1042,257 C 1198.3999999999999,248.53333333333333 1319.1999999999998,224.26666666666665 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   75% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 112,196.8 224,193.6 407,202 C 590,210.4 844,230.4 1028,232 C 1212,233.6 1326,216.8 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   100% {
//                     d: path(
...
//                   0% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 173.46666666666664,177.33333333333331 346.9333333333333,154.66666666666666 493,145 C 639.0666666666667,135.33333333333334 757.7333333333333,138.66666666666669 911,150 C 1064.2666666666667,161.33333333333331 1252.1333333333332,180.66666666666666 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   25% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 198.93333333333334,174.8 397.8666666666667,149.6 538,160 C 678.1333333333333,170.4 759.4666666666667,216.4 900,229 C 1040.5333333333333,241.6 1240.2666666666667,220.8 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   50% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 169.86666666666667,230.93333333333334 339.73333333333335,261.8666666666667 477,243 C 614.2666666666667,224.13333333333335 718.9333333333334,155.46666666666667 874,140 C 1029.0666666666666,124.53333333333333 1234.5333333333333,162.26666666666665 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   75% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 130.53333333333336,167.86666666666667 261.0666666666667,135.73333333333332 418,138 C 574.9333333333333,140.26666666666668 758.2666666666667,176.93333333333334 933,193 C 1107.7333333333333,209.06666666666666 1273.8666666666668,204.53333333333333 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   100% {
//                     d: path(
...
//                 <div className={cn("flex content-stretch transition-all duration-700")}>
//                   <HeroCard
//                     content="We, SilverBack provide a full-service experience for clients with in-house departments for logistics, project management, finance and accounting, IT and human resources, ensuring that all aspects of the project are covered."
//                     heading="Comprehensive services"
//                     fallBack="In-house logistics, project management, finance and accounting, IT and human resources."
//                     icon={<Building className="h-6 w-6 min-[1125px]:h-8 min-[1125px]:w-8" />}
//                   />
//                 </div>
//                 <div className={cn("flex content-stretch transition-all duration-1000")}>
//                   <HeroCard
//                     content="Our team of professionals is experienced in cutting-edge technologies for data center, battery factory construction etc., providing innovative solutions for our partners and clients."
//                     heading="Expertise & innovation"
//                     fallBack="Specialized in data center, battery factory, infrastructure construction etc."
//                     icon={<Lightbulb className="h-6 w-6 min-[1125px]:h-8 min-[1125px]:w-8" />}
//                   />
//                 </div>
//                 <div className={cn("flex content-stretch transition-all duration-1000")}>
//                   <HeroCard
...
//                     icon={<MessagesSquare className="h-6 w-6 min-[1125px]:h-8 min-[1125px]:w-8" />}
//                   />
//                 </div>
//                 <div className={cn("flex content-stretch transition-all duration-700")}>
//                   <HeroCard
...
//                     icon={<Globe2 className="h-6 w-6 min-[1125px]:h-8 min-[1125px]:w-8" />}
//                   />
//                 </div>
...
//                     Making the future easy, green, and productive.{" "}
//                     <Button className="p-0 leading-none" size="sm" variant="link">
//                       Connect
//                     </Button>
//                   </div>
//                 </div>
...
//                   0% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 101.78571428571428,227.85714285714286 203.57142857142856,255.71428571428572 336,235 C 468.42857142857144,214.28571428571428 631.5,145.00000000000003 763,149 C 894.5,152.99999999999997 994.4285714285716,230.28571428571428 1102,251 C 1209.5714285714284,271.7142857142857 1324.7857142857142,235.85714285714286 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   25% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 145.14285714285717,240.89285714285714 290.28571428571433,281.7857142857143 420,272 C 549.7142857142857,262.2142857142857 664.0000000000001,201.75 761,202 C 857.9999999999999,202.25 937.7142857142858,263.2142857142857 1048,273 C 1158.2857142857142,282.7857142857143 1299.142857142857,241.39285714285714 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   50% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 153.25,209.78571428571428 306.5,219.57142857142858 423,212 C 539.5,204.42857142857142 619.25,179.5 728,181 C 836.75,182.5 974.5,210.42857142857144 1098,218 C 1221.5,225.57142857142856 1330.75,212.78571428571428 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   75% {
//                     d: path(
//                       "M 0,400 C 0,400 0,200 0,200 C 109.17857142857142,223.75 218.35714285714283,247.5 347,227 C 475.64285714285717,206.5 623.7500000000001,141.75 751,146 C 878.2499999999999,150.25 984.6428571428571,223.5 1096,244 C 1207.357142857143,264.5 1323.6785714285716,232.25 1440,200 C 1440,200 1440,400 1440,400 Z"
//                     );
//                   }
//                   100% {
//                     d: path(
...
//                       heading="Data Center"
//                     />
//                     <FeaturesCard Icon={Sofa} content="Create Space to Life" heading="Apartment" />
//                     <FeaturesCard
//                       Icon={Workflow}
//                       content="Bridging Dreams, Connecting Lives"
//                       heading="Bridge"
//                     />
//                     <FeaturesCard Icon={Factory} content="Producing the Future" heading="Factory" />
//                     <FeaturesCard
//                       Icon={HeartHandshake}
//                       content="Caring Beyond Boundaries"
//                       heading="Hospital"
...
//                       heading="Substation"
//                     />
//                     <FeaturesCard Icon={Wind} content="Harnessing the Wind" heading="Wind Farms" />
//                     <FeaturesCard
//                       Icon={Printer}
//                       content="Crafting Sustainability, Page by Page"
//                       heading="Paper Mill"
