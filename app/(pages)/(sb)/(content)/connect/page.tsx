...
import { FlowBackground, HeroCards, Typewriter } from "./comp";
import { Building, Globe2, Lightbulb, MessagesSquare } from "lucide-react";
  ...
  return (
    <div className="relative">
      <div className="text-center">
        ...
        <div className="h-screen text-left relative  text-primary z-20 mt-32">
